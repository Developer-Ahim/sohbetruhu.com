var regSpinner = '<i class="fa fa-circle-o-notch fa-spin fa-fw bspin reg_spinner"></i>';
var menuSpinner = '<div class="menu_spinner_wrap"><i class="fa fa-circle-o-notch fa-spin fa-fw bspin menu_spinner"></i></div>';
var largeSpinner = '<div class="large_spinner"><i class="fa fa-circle-o-notch fa-spin fa-fw bspin boom_spinner"></i></div>';
